...
exports.CreateProjectSchema = zod_1.z.object({
    ...
    deadline: zod_1.z.preprocess((val) => {
        ...
        return val;
    }, zod_1.z.string().datetime().nullable().optional()),
    slackChannelId: zod_1.z.preprocess((val) => (val === '' || val === null || val === undefined ? null : val), zod_1.z.string().min(1).nullable().optional()),
